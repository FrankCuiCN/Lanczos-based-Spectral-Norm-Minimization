...
class ResNet(nn.Module):
    def __init__(self):
        ...
        self.conv1 = convolution(3, 64, kernel_size=3, stride=1, padding=1, bias=False)
        self.normalization1 = normalization(64)
        self.activation = activation()

        self.layer1 = make_layer(BasicBlock, 64, 64, num_blocks=2, stride=1)
        self.layer2 = make_layer(BasicBlock, 64, 128, num_blocks=2, stride=2)
        self.layer3 = make_layer(BasicBlock, 128, 256, num_blocks=2, stride=2)
        self.layer4 = make_layer(BasicBlock, 256, 512, num_blocks=2, stride=2)
